...
const Brush = function (wgl, shaderSources, maxBristleCount) {
    this.wgl = wgl;
    ...
    this.projectProgram = wgl.createProgram(
        shaderSources['fullscreen.vert'], shaderSources['project.frag']);

    this.distanceConstraintProgram = wgl.createProgram(
        shaderSources['fullscreen.vert'], shaderSources['distanceconstraint.frag']);

    this.planeConstraintProgram = wgl.createProgram(
        shaderSources['fullscreen.vert'], shaderSources['planeconstraint.frag']);

    this.bendingConstraintProgram = wgl.createProgram(
        shaderSources['fullscreen.vert'], shaderSources['bendingconstraint.frag']);

    this.setBristlesProgram = wgl.createProgram(
        shaderSources['fullscreen.vert'], shaderSources['setbristles.frag']);

    this.updateVelocityProgram = wgl.createProgram(
        shaderSources['fullscreen.vert'], shaderSources['updatevelocity.frag']);
